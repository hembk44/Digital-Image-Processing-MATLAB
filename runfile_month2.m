function [x,finalGreenness_index] = runfile_month2(lengthx, finalGreenness_index, x)

%specify the folder for the images
folder = 'C:\Users\baralhems12\Desktop\MATLAB\codes\2_Feb_2015'; % change this to the location of the images
