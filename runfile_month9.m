function [x,finalGreenness_index] = runfile_month9(lengthx, finalGreenness_index, x)

%specify the folder for the images
folder = 'C:\Users\baralhems12\Desktop\MATLAB\codes\9_Sep_2015'; % change this to the location of the images
