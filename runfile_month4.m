function [x,finalGreenness_index] = runfile_month4(lengthx, finalGreenness_index, x)

%specify the folder for the images
folder = 'C:\Users\baralhems12\Desktop\MATLAB\codes\4_Apr_2015'; % change this to the location of the images
